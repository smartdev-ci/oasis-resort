...
export const translations = {
  fr: {
    ...
    hero_placeholder: 'Trouvez-moi un hôtel en bord de mer à Assinie pour 3 nuits à moins de 100 000 FCFA',
    ...
    suggestion_beach_prompt: 'Trouvez-moi un hôtel en bord de mer avec vue sur l\'océan pour 3 nuits à moins de 90 000 FCFA',
    suggestion_business_prompt: 'J\'ai besoin d\'un hôtel d\'affaires près de l\'aéroport d\'Abidjan avec Wi-Fi rapide et salle de conférence',
    suggestion_romantic_prompt: 'Planifiez un week-end romantique pour deux avec spa et vue mer à moins de 200 000 FCFA',
    suggestion_family_prompt: 'Réservez une villa familiale avec piscine et jardin pour 5 personnes à moins de 80 000 FCFA par nuit',
    suggestion_last_minute_prompt: 'Montrez-moi les hôtels disponibles pour cette nuit à Abidjan avec réservation instantanée',

    // AI Discovery
    discovery_badge: 'Sélectionné par l\'IA pour vous',
    discovery_title: 'Recommandé par votre IA',
    discovery_subtitle: 'Basé sur vos préférences, vos réservations passées et la disponibilité en temps réel dans 8 villes africaines.',
    discovery_view_all: 'Voir toutes les recommandations',
    discovery_ai_insight: 'Aperçu IA :',
    discovery_match: 'match',
    discovery_ai_text: 'Vous réservez habituellement des hôtels avec piscine et accès à l\'aéroport. L\'Assinie Beach Resort correspond à 94% de vos habitudes de voyage.',

    // Smart Map
    map_badge: 'Géo-intelligence IA',
    map_title: 'Explorez l\'Afrique en toute confiance',
    map_subtitle: 'Votre IA met en évidence les zones sûres, les quartiers touristiques, les zones d\'affaires et les quartiers familiaux.',
    ...
    conv_subtitle: 'Votre assistant IA comprend le langage naturel. Affinez votre recherche par des questions — comme parler à un ami expert local.',
    ...
    feat_f1_desc: 'Décrivez votre voyage en langage naturel. Pas de menus déroulants, pas de filtres sans fin — juste la conversation.',
    feat_f2_title: 'Mobile Money natif',
    feat_f2_desc: 'Payez avec Orange Money, MTN Money, Moov Money, Wave ou carte. Conçu pour l\'Afrique, utilisé partout.',
    feat_f3_title: 'Séjours africains vérifiés',
    feat_f3_desc: 'Chaque propriété est contrôlée. L\'analyse des avis par IA remplace le bruit par la clarté.',
    feat_f4_title: 'Réservation instantanée',
    feat_f4_desc: 'Pas d\'allers-retours. Confirmez, payez et obtenez un concierge de voyage instantanément.',
    ...
    search_ai_priority: 'Basé sur votre demande, j\'ai priorisé les propriétés avec Wi-Fi rapide, proximité aéroport et Mobile Money.',
    ...
    search_no_results_sub: 'Essayez de demander à l\'IA des alternatives ou ajustez vos filtres.',
    search_map: 'Carte',
    search_list: 'Liste',
    ...
    details_tour_subtitle: 'Explorez la chambre sous tous les angles. Faites glisser pour pivoter.',
    ...
    checkout_ai_tip_text: 'Cet hôtel est complet le week-end. Pensez à réserver maintenant — seulement',
    checkout_ai_rec: 'Recommande l\'IA :',
    checkout_ai_room_rec: 'La chambre Deluxe offre le meilleur rapport qualité-prix — vue piscine, balcon et minibar inclus.',
    ...
    checkout_ai_here: 'Je suis là si vous avez des questions. Besoin d\'aide avec les dates, le paiement ou des demandes spéciales ?',
    checkout_confirmed_title: 'Réservation confirmée !',
    checkout_confirmed_text: 'Votre séjour à',
    checkout_confirmed_text2: 'est confirmé. Votre concierge IA de voyage est prêt.',
    ...
    compare_add_sub: 'Sélectionnez au moins 2 propriétés depuis les résultats de recherche pour voir une comparaison IA.',
    ...
    compare_ai_rec: 'Chacune offre une valeur distincte — voici ma recommandation basée sur vos préférences de voyage.',
    ...
    concierge_subtitle2: 'inoubliable. Du transfert aéroport aux réservations, demandez simplement.',
    concierge_web: 'Web',
    ...
    concierge_ai_1: 'Votre vol arrive à 15h00. Je recommande de réserver le transfert aéroport maintenant pour éviter les files.',
    concierge_ai_2: 'Un restaurant populaire "Le N\'dolé" est à 800m de votre hôtel. Parfait pour le dîner ce soir.',
    concierge_ai_3: 'Ce week-end : Festival de musique d\'Assinie Beach. À 2km de votre hôtel.',
    ...
    concierge_chat_3: 'Voulez-vous que je réserve votre transfert aéroport ? C\'est à 25 min de l\'aéroport.',
    concierge_chat_4: 'Oui s\'il vous plaît ! Et des recommandations de restaurants ?',
    concierge_chat_5: 'Parfait ! J\'ai organisé votre transfert. Pour le dîner, je recommande 3 spots locaux :',
    concierge_chat_6: '1. Le N\'dolé — Cuisine ivoirienne (800m)\n2. La Baignoire — Fine cuisine française (1,2km)\n3. Chez Ramage — Fruits de mer au bord du lagon (2km)',
    ...
    service_airport_desc: 'Réservez une voiture privée depuis l\'aéroport Félix Houphouët-Boigny jusqu\'à votre hôtel. 25 minutes de trajet.',
    service_taxi_title: 'Réservation de taxi',
    service_taxi_desc: 'Service de taxi à la demande avec des chauffeurs locaux vérifiés. Espèces ou Mobile Money.',
    service_restaurant_title: 'Recommandations de restaurants',
    service_restaurant_desc: 'Restaurants locaux les mieux notés à moins de 2 km. Cuisine ivoirienne, française et internationale.',
    service_events_title: 'Événements locaux',
    service_events_desc: '3 événements ce week-end : musique live, exposition d\'art et festival gastronomique.',
    service_tours_title: 'Activités touristiques',
    service_tours_desc: 'Visites guidées de la plage d\'Assinie, du Parc national du Banco et des marchés locaux.',
    ...
    ai_found_business: 'hôtels business près de l\'aéroport d\'Abidjan. Tous ont Wi-Fi rapide, salles de conférence et navettes aéroport.',
    ai_found_romantic: 'escapades romantiques parfaites pour les couples. J\'ai filtré par vues océan, spa et balcons privés.',
    ai_found_family: 'options familiales avec piscines, jardins et chambres familiales. Basé sur vos réservations passées, vous adorerez ces options.',
    ai_found_lastminute: 'hôtels disponibles ce soir à Abidjan avec réservation instantanée. Les prix sont 15% moins chers que d\'habitude.',
    ai_found_cheaper: 'options plus abordables à moins de 50 000 FCFA par nuit. Toutes très bien notées et avec Mobile Money accepté.',
    ai_found_breakfast: 'Filtré pour afficher uniquement les propriétés avec petit-déjeuner compris. 4 options correspondent.',
    ai_found_5star: 'Voici les hôtels 5 étoiles les mieux notés dans votre zone. Tous notés 4,7+ avec un service exceptionnel.',
    ai_found_default: 'J\'ai analysé 247 propriétés dans 8 villes africaines. Basé sur votre demande, voici les meilleures correspondances.',
    ...
    // AI response chips
    ai_chips_beach: ['Options moins chères', 'Avec petit-déjeuner', 'Hôtels 5 étoiles', 'Plus de détails'],
    ai_chips_business: ['Options moins chères', 'Avec petit-déjeuner', 'Plus proche aéroport', 'Avec parking'],
    ai_chips_romantic: ['Moins de 100 000 FCFA', 'Avec spa', 'Vue mer uniquement', 'Tout inclus'],
    ai_chips_family: ['Moins de 80 000 FCFA', 'Avec piscine enfants', '5+ chambres', 'Animaux acceptés'],
    ai_chips_last_minute: ['Tout voir', 'Moins de 50 000 FCFA', 'Proche aéroport', 'Note 4+'],
    ai_chips_cheaper: ['Moins de 35 000 FCFA', 'Avec petit-déjeuner', 'Proche aéroport', 'Avec piscine'],
    ai_chips_breakfast: ['Options moins chères', 'Proche aéroport', 'Tout voir', '5 étoiles'],
    ai_chips_5star: ['Options moins chères', 'Avec petit-déjeuner', 'Familles', 'Plus de détails'],
    ai_chips_default: ['Options moins chères', 'Avec petit-déjeuner', 'Familles', 'Hôtels 5 étoiles'],

    // Footer
    footer_tagline: 'La plateforme IA de réservation de voyage en Afrique. Décrivez votre voyage idéal — on s\'occupe du reste.',
    ...
    sites_subtitle: 'Découvrez les merveilles naturelles et culturelles du continent africain.',
    sites_search_placeholder: 'Rechercher un site touristique, une ville, un pays...',
    ...
    // SearchResults
    search_query_default: "J'ai besoin d'un hôtel calme près de l'aéroport d'Abidjan",
    search_ai_reqs: "Basé sur votre demande, j'ai priorisé les propriétés avec Wi-Fi rapide, proximité aéroport et Mobile Money.",
    ...
    compare_recommendation: "Chacune offre une valeur distincte — voici ma recommandation basée sur vos préférences de voyage.",
    ...
    concierge_chat_q1: "Voulez-vous que je réserve votre transfert aéroport ? C'est à 25 min de l'aéroport.",
    concierge_chat_a1: "Oui s'il vous plaît ! Et des recommandations de restaurants ?",
    concierge_chat_q2: "Parfait ! J'ai organisé votre transfert. Pour le dîner, je recommande 3 spots locaux :",
    concierge_chat_restaurants: "1. Le N'dolé — Cuisine ivoirienne (800m)\n2. La Baignoire — Fine cuisine française (1,2km)\n3. Chez Ramage — Fruits de mer au bord du lagon (2km)",
  ...
  en: {
    ...
    hero_placeholder: 'Find me a beachfront hotel in Assinie for 3 nights under 100,000 FCFA',
    hero_search: 'Search',
    ...
    suggestion_beach_prompt: 'Find me a beachfront hotel with ocean view for 3 nights under 90,000 FCFA',
    suggestion_business_prompt: 'I need a business hotel near Abidjan airport with fast Wi-Fi and conference room',
    suggestion_romantic_prompt: 'Plan a romantic weekend getaway for two with spa and ocean views under 200,000 FCFA',
    suggestion_family_prompt: 'Book a family-friendly villa with pool and garden for 5 people under 80,000 FCFA per night',
    suggestion_last_minute_prompt: 'Show me available hotels for tonight in Abidjan with instant booking',

    // AI Discovery
    discovery_badge: 'AI-curated for you',
    discovery_title: 'Recommended by your AI',
    discovery_subtitle: 'Based on your preferences, past bookings, and real-time availability across 8 African cities.',
    discovery_view_all: 'View all recommendations',
    discovery_ai_insight: 'AI Insight:',
    discovery_match: 'match',
    discovery_ai_text: 'You usually book hotels with pools and airport access. Assinie Beach Resort matches 94% of your travel patterns.',

    // Smart Map
    map_badge: 'AI-powered geo-intelligence',
    map_title: 'Explore Africa with confidence',
    map_subtitle: 'Your AI highlights safe areas, tourist districts, business zones, and family-friendly neighborhoods.',
    ...
    conv_subtitle: 'Your AI travel companion understands natural language. Refine your search through follow-up prompts — like talking to a friend who happens to be a local expert.',
    conv_online: 'Online',
    ...
    feat_f1_desc: 'Describe your trip in natural language. No dropdowns, no endless filters — just conversation.',
    feat_f2_title: 'Mobile Money native',
    feat_f2_desc: 'Pay with Orange Money, MTN Money, Moov Money, Wave, or cards. Built for Africa, used everywhere.',
    feat_f3_title: 'Verified African stays',
    feat_f3_desc: 'Every property is vetted. AI-generated review analysis replaces noise with clarity.',
    feat_f4_title: 'Instant booking',
    feat_f4_desc: 'No back-and-forth. Confirm, pay, and get a travel concierge instantly.',
    ...
    search_ai_priority: 'Based on your query, I\'ve prioritized properties with fast Wi-Fi, airport proximity, and mobile money acceptance.',
    ...
    search_no_results_sub: 'Try asking the AI for alternatives or adjust your filters.',
    search_map: 'Map',
    search_list: 'List',
    ...
    details_tour_subtitle: 'Explore the room from every angle. Drag to rotate and discover the space.',
    ...
    checkout_ai_tip_text: 'This hotel gets fully booked on weekends. Consider booking now — only',
    checkout_ai_rec: 'AI recommends:',
    checkout_ai_room_rec: 'The Deluxe Room offers the best value — pool view, balcony, and minibar included.',
    ...
    checkout_ai_here: 'I\'m right here if you have any questions. Need help with dates, payment, or special requests?',
    checkout_confirmed_title: 'Booking Confirmed!',
    checkout_confirmed_text: 'Your stay at',
    checkout_confirmed_text2: 'is confirmed. Your AI travel concierge is ready.',
    ...
    compare_add_sub: 'Select at least 2 properties from search results to see an AI-powered comparison.',
    ...
    compare_ai_rec: 'Each offers distinct value — here\'s my recommendation based on your travel preferences.',
    ...
    concierge_subtitle2: 'unforgettable. From airport transfers to dinner reservations, just ask.',
    concierge_web: 'Web',
    ...
    concierge_ai_1: 'Your flight arrives at 3:00 PM. I recommend booking airport transfer now to avoid queues.',
    concierge_ai_2: 'A popular restaurant "Le N\'dolé" is 800m from your hotel. Perfect for dinner tonight.',
    concierge_ai_3: 'This weekend: Assinie Beach Music Festival. 2km from your hotel.',
    ...
    concierge_chat_3: 'Want me to book your airport transfer? It\'s 25 min from the airport.',
    concierge_chat_4: 'Yes please! And any restaurant recommendations?',
    concierge_chat_5: 'Perfect! I\'ve arranged your transfer. For dinner, I recommend 3 local spots:',
    concierge_chat_6: '1. Le N\'dolé — Ivoirian cuisine (800m)\n2. La Baignoire — French fine dining (1.2km)\n3. Chez Ramage — Seafood by the lagoon (2km)',
    ...
    service_airport_desc: 'Book a private car from Félix Houphouët-Boigny Airport to your hotel. 25-minute drive.',
    service_taxi_title: 'Taxi Booking',
    service_taxi_desc: 'On-demand taxi service with vetted local drivers. Cash or Mobile Money.',
    service_restaurant_title: 'Restaurant Recommendations',
    service_restaurant_desc: 'Top-rated local restaurants within 2km. Ivoirian, French, and international cuisine.',
    service_events_title: 'Local Events',
    service_events_desc: '3 events happening this weekend: live music, art exhibition, and food festival.',
    service_tours_title: 'Tourist Activities',
    service_tours_desc: 'Guided tours to Assinie Beach, Banco National Park, and local markets.',
    ...
    ai_found_business: 'business-friendly hotels near Abidjan airport. All have fast Wi-Fi, conference rooms, and airport shuttles.',
    ai_found_romantic: 'romantic getaways perfect for couples. I\'ve filtered for ocean views, spa services, and private balconies.',
    ai_found_family: 'family-friendly options with pools, gardens, and family rooms. Based on your past bookings, you\'ll love these.',
    ai_found_lastminute: 'hotels available for tonight in Abidjan with instant booking. Prices are 15% lower than usual.',
    ai_found_cheaper: 'more affordable options under 50,000 FCFA per night. All still highly rated and with Mobile Money accepted.',
    ai_found_breakfast: 'Filtered to show only properties with complimentary breakfast included. 4 options match.',
    ai_found_5star: 'Here are the top-rated 5-star hotels in your area. All rated 4.7+ with exceptional service.',
    ai_found_default: 'I\'ve analyzed 247 properties across 8 African cities. Based on your request, here are the best matches.',
    ...
    // AI response chips
    ai_chips_beach: ['Cheaper options', 'Add breakfast', 'Show only 5-star', 'More details'],
    ai_chips_business: ['Cheaper options', 'Add breakfast', 'Closer to airport', 'With parking'],
    ai_chips_romantic: ['Under 100,000 FCFA', 'With spa', 'Ocean view only', 'All-inclusive'],
    ai_chips_family: ['Under 80,000 FCFA', 'With kids pool', '5+ bedrooms', 'Pet friendly'],
    ai_chips_last_minute: ['Show all', 'Under 50,000 FCFA', 'Near airport', '4+ stars'],
    ai_chips_cheaper: ['Under 35,000 FCFA', 'Add breakfast', 'Near airport', 'With pool'],
    ai_chips_breakfast: ['Cheaper options', 'Near airport', 'Show all', '5-star only'],
    ai_chips_5star: ['Cheaper options', 'Add breakfast', 'Family friendly', 'More details'],
    ai_chips_default: ['Cheaper options', 'Add breakfast', 'Family friendly', 'Show only 5-star hotels'],

    // Footer
    footer_tagline: 'Africa\'s AI-first travel booking platform. Describe your perfect trip — we\'ll handle the rest.',
    ...
    sites_subtitle: 'Discover the natural and cultural wonders of the African continent, curated by our AI.',
    ...
    search_ai_reqs: 'Based on your query, I\'ve prioritized properties with fast Wi-Fi, airport proximity, and mobile money acceptance.',
    ...
    compare_recommendation: 'Each offers distinct value — here\'s my recommendation based on your travel preferences.',
    ...
    concierge_chat_q1: 'Want me to book your airport transfer? It\'s 25 min from the airport.',
    concierge_chat_a1: 'Yes please! And any restaurant recommendations?',
    concierge_chat_q2: 'Perfect! I\'ve arranged your transfer. For dinner, I recommend 3 local spots:',
    concierge_chat_restaurants: '1. Le N\'dolé — Ivoirian cuisine (800m)\n2. La Baignoire — French fine dining (1.2km)\n3. Chez Ramage — Seafood by the lagoon (2km)',
    ...
    help_a1: 'Vous pouvez modifier votre réservation via votre profil ou en contactant notre service client. Les modifications sont gratuites jusqu\'à 48h avant l\'arrivée.',
    help_q2: 'Puis-je annuler ma réservation ?',
    help_a2: 'Oui, l\'annulation est gratuite jusqu\'à 48h avant l\'entrée. Après cette période, des frais peuvent s\'appliquer.',
    help_q3: 'Comment voir mes réservations ?',
    help_a3: 'Toutes vos réservations sont visibles dans l\'onglet "Mes Voyages" de votre profil.',
    help_q4: 'Quels moyens de paiement sont acceptés ?',
    help_a4: 'Nous acceptons les cartes bancaires, le Mobile Money (Orange Money, MTN Money, Moov, Wave) et les virements.',
    help_q5: 'Le paiement Mobile Money est-il sécurisé ?',
    help_a5: 'Oui, toutes les transactions Mobile Money sont chiffrées et sécurisées par nos partenaires financiers.',
    help_q6: 'Puis-je payer en plusieurs fois ?',
    help_a6: 'Oui, nous proposons des options de paiement en plusieurs fois pour les séjours de plus de 3 nuits.',
    help_q7: 'Comment les propriétés sont-elles vérifiées ?',
    help_a7: 'Chaque propriété est visitée et vérifiée par notre équipe. Nous contrôlons la qualité, la propreté et les équipements.',
    help_q8: 'Les photos correspondent-elles à la réalité ?',
    help_a8: 'Oui, toutes les photos sont récentes et représentent fidèlement les propriétés.',
    help_q9: 'Puis-je visiter une propriété avant de réserver ?',
    help_a9: 'Oui, vous pouvez demander une visite virtuelle 360° ou une visite physique selon disponibilité.',
    help_q10: 'Comment réinitialiser mon mot de passe ?',
    help_a10: 'Utilisez le lien "Mot de passe oublié ?" sur la page de connexion ou contactez notre support.',
    help_q11: 'Puis-je modifier mes informations personnelles ?',
    help_a11: 'Oui, vous pouvez modifier vos informations dans l\'onglet "Mes Infos" de votre profil.',
    help_q12: 'Comment supprimer mon compte ?',
    help_a12: 'Contactez notre service client pour demander la suppression de votre compte.',
    help_contact_title: 'Nous contacter',
    help_contact_subtitle: 'Notre équipe est disponible pour répondre à toutes vos questions.',
    ...
    // Experiences page
    experiences_title: 'Expériences uniques',
    experiences_subtitle: 'Découvrez des activités inoubliables pour rendre votre voyage exceptionnel',
    experiences_back: 'Retour',
    experiences_all: 'Toutes',
    experiences_culture: 'Culture',
    experiences_adventure: 'Aventure',
    experiences_gastronomy: 'Gastronomie',
    experiences_wellness: 'Bien-être',
    experiences_categories: 'Catégories',
    experiences_popular: 'Populaires',
    experiences_all_title: 'Toutes les expériences',
    experiences_book: 'Réserver',
    experiences_no_results: 'Aucune expérience trouvée',
    experiences_no_results_sub: 'Essayez une autre catégorie ou changez vos critères',
    experiences_popular_badge: 'Populaire',
    experiences_banner_title: 'Découvrez l\'Afrique différemment',
    experiences_banner_subtitle: 'Des expériences authentiques sélectionnées par nos experts locaux',
    experiences_banner_alt: 'Paysage africain',

    // Travel page
    travel_title: 'Mes Voyages',
    travel_subtitle: 'Gérez toutes vos réservations et vos voyages',
    travel_back: 'Retour',
    travel_current: 'En cours',
    travel_upcoming: 'À venir',
    travel_past: 'Passés',
    travel_stats_upcoming: 'Voyages à venir',
    travel_stats_completed: 'Voyages terminés',
    travel_stats_countries: 'Pays visités',
    travel_no_trips: 'Aucun voyage',
    travel_no_trips_sub: 'Vous n\'avez aucun voyage prévu pour l\'instant',
    travel_plan_new: 'Planifier un nouveau voyage',
    travel_details: 'Détails',
    travel_checkin: 'Enregistrement',
    travel_status_confirmed: 'Confirmé',
    travel_status_pending: 'En attente',
    travel_status_cancelled: 'Annulé',
    travel_status_completed: 'Terminé',
    ...
    profile_booking_3: 'Tiama Hôtel',
    profile_booking_status_confirmed: 'Confirmé',
    profile_booking_status_pending: 'En attente',
    profile_booking_status_completed: 'Terminé',
    profile_favorite_1: 'Villa de luxe avec vue sur l\'océan',
    profile_favorite_2: 'Appartement moderne en centre-ville',
    profile_favorite_3: 'Maison familiale confortable',
    profile_loc_abidjan: 'Abidjan',
    profile_loc_yopougon: 'Yopougon',
    profile_loc_cocody: 'Cocody',
    profile_no_bookings: 'Aucune réservation',
    profile_no_favorites: 'Aucun favori',
    profile_settings_notifications: 'Notifications',
    profile_settings_payment: 'Méthodes de paiement',
    profile_settings_security: 'Sécurité',
    profile_settings_preferences: 'Préférences',

    // Experience details
    experience_1_title: 'Visite guidée d\'Abidjan',
    experience_1_desc: 'Découvrez la capitale économique de la Côte d\'Ivoire',
    experience_2_title: 'Visite historique de Grand-Bassam',
    experience_2_desc: 'Explorez le site du patrimoine mondial de l\'UNESCO',
    experience_3_title: 'Expérience culinaire abidjanaise',
    experience_3_desc: 'Goûtez une cuisine ivoirienne authentique',
    experience_4_title: 'Journée spa et bien-être',
    experience_4_desc: 'Détendez-vous dans un spa de luxe',
    experience_5_title: 'Tour culturel de Cocody',
    experience_5_desc: 'Visitez des musées et galeries d\'art',
    experience_6_title: 'Aventure plage à Assinie',
    experience_6_desc: 'Profitez des sports nautiques et de la détente en bord de mer',
    ...
    // Trip details
    trip_1_title: 'Escapade à Paris',
    trip_2_title: 'Voyage d\'affaires à New York',
    trip_3_title: 'Aventure à Dubaï',
    trip_4_title: 'Découverte de Tokyo',
    trip_5_title: 'Week-end à Londres',
    trip_6_title: 'Retraite à Bali',
    trip_dest_paris: 'Paris, France',
    trip_dest_new_york: 'New York, États-Unis',
    trip_dest_dubai: 'Dubaï, Émirats Arabes Unis',
    trip_dest_tokyo: 'Tokyo, Japon',
    trip_dest_london: 'Londres, Royaume-Uni',
    trip_dest_bali: 'Bali, Indonésie',
    trip_accommodation_hotel: 'Hôtel',
    trip_accommodation_apartment: 'Appartement',
    trip_accommodation_resort: 'Complexe hôtelier',
    trip_accommodation_villa: 'Villa',
    trip_transport_flight: 'Vol',
    trip_transport_car: 'Voiture',
    trip_transport_train: 'Train',
    trip_transport_ship: 'Bateau',
  },
  ...
  en: {
    ...
    help_q1: 'How to modify a reservation?',
    help_a1: 'You can modify your reservation through your profile or by contacting our customer service.',
    help_q2: 'Can I cancel my reservation?',
    help_a2: 'Yes, cancellation is free up to 48 hours before check-in.',
    help_q3: 'How to view my reservations?',
    help_a3: 'All your reservations are visible in the My Trips tab of your profile.',
    help_q4: 'What payment methods are accepted?',
    help_a4: 'We accept bank cards, Mobile Money (Orange Money, MTN Money, Moov, Wave) and wire transfers.',
    help_q5: 'Is Mobile Money payment secure?',
    help_a5: 'Yes, all Mobile Money transactions are encrypted and secured by our financial partners.',
    help_q6: 'Can I pay in installments?',
    help_a6: 'Yes, we offer installment payment options for stays longer than 3 nights.',
    help_q7: 'How are properties verified?',
    help_a7: 'Each property is visited and verified by our team. We check quality, cleanliness and amenities.',
    help_q8: 'Do the photos match reality?',
    help_a8: 'Yes, all photos are recent and faithfully represent the properties.',
    help_q9: 'Can I visit a property before booking?',
    help_a9: 'Yes, you can request a 360° virtual tour or a physical visit depending on availability.',
    help_q10: 'How to reset my password?',
    help_a10: 'Use the Forgot password link on the login page or contact our support.',
    help_q11: 'Can I modify my personal information?',
    help_a11: 'Yes, you can modify your information in the My Info tab of your profile.',
    help_q12: 'How to delete my account?',
    help_a12: 'Contact our customer service to request the deletion of your account.',
    help_contact_title: 'Contact Us',
    help_contact_subtitle: 'Our team is available to answer all your questions.',
    help_contact_email: 'Email',
    help_contact_phone: 'Phone',
    help_contact_chat: 'Live Chat',
    help_contact_chat_desc: 'Chat with us in real time',
    help_tips_title: 'Helpful Tips',
    help_tip1: 'Book early to get the best rates',
    help_tip2: 'Check reviews from other travelers',
    help_tip3: 'Use AI filters to refine your searches',
    help_no_results: 'No results found for your search',

    // Experiences page
    experiences_title: 'Unique Experiences',
    experiences_subtitle: 'Discover unforgettable activities to make your trip exceptional',
    ...
    experiences_no_results_sub: 'Try another category or change your criteria',
    experiences_popular_badge: 'Popular',
    experiences_banner_title: 'Discover Africa differently',
    experiences_banner_subtitle: 'Authentic experiences selected by our local experts',
    ...
    travel_no_trips_sub: 'You do not have any trips planned yet',
    ...
    profile_info_address_value: 'Abidjan, Plateau, Ivory Coast',
    profile_edit: 'Edit Profile',
    profile_save: 'Save',
    profile_cancel: 'Cancel',
    profile_signout: 'Sign Out',
    profile_booking_1: 'Sofitel Abidjan Hotel Ivoire',
    profile_booking_2: 'Pullman Abidjan',
    ...
    profile_favorite_2: 'Modern Apartment Downtown',
    profile_favorite_3: 'Cozy Family House',
    profile_loc_abidjan: 'Abidjan',
    profile_loc_yopougon: 'Yopougon',
    profile_loc_cocody: 'Cocody',
    ...
    // Experience details
    experience_1_title: 'Abidjan City Tour',
    experience_1_desc: 'Discover the economic capital of Ivory Coast',
    experience_2_title: 'Grand Bassam Historical Visit',
    ...
    experience_4_title: 'Wellness Spa Day',
    experience_4_desc: 'Relax and rejuvenate at a luxury spa',
    experience_5_title: 'Cocody Cultural Tour',
    experience_5_desc: 'Visit museums and art galleries',
    experience_6_title: 'Assinie Beach Adventure',
    experience_6_desc: 'Enjoy water sports and beach relaxation',
    experience_loc_abidjan: 'Abidjan',
    experience_loc_grand_bassam: 'Grand Bassam',
    experience_loc_plateau: 'Plateau',
    experience_loc_yopougon: 'Yopougon',
    ...
    trip_2_title: 'New York Business Trip',
    trip_3_title: 'Dubai Adventure',
    trip_4_title: 'Tokyo Discovery',
    trip_5_title: 'London Weekend',
    trip_6_title: 'Bali Retreat',
    trip_dest_paris: 'Paris, France',
    trip_dest_new_york: 'New York, USA',
    trip_dest_dubai: 'Dubai, UAE',
    trip_dest_tokyo: 'Tokyo, Japan',
    trip_dest_london: 'London, UK',
